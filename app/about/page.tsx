...
import type { ExperienceData } from "../components/ExperienceListing";
...
//     const query = `
//     *[_type == "experience"] | order(yearstart desc) {
//         title,
//         desc,
//         yearstart,
//         yearend,
...
async function getEducation() {
    const query = `
    *[_type == "education"] | order(yearstart desc) {
        title,
        desc,
        yearstart,
        yearend,
...
export default async function About() {
    ...
    const experience: ExperienceData[] = await getExperience();
    const education: EducationData[] = await getEducation();
    ...
    return (
        <div className="divide-y divide-gray-100 dark:divide-gray-700">
            ...
            <div className="self-start items-top space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
                    ...
                    <div className="flex space-x-5 pt-6">
                        <a href="" target="_blank">
                            <svg
                                ...
                                fill="currentColor"
                                className="w-8 h-8 text-black  hover:text-gray-600 dark:text-white dark:hover:text-gray-400"
                            >
                        ...
                        <a href="https://www.linkedin.com/in/elson-ng-yuan-da/" target="_blank">
                            <svg
                                viewBox="0 0 1024 1024"
                                fill="currentColor"
                                className="w-8 h-8 text-black  hover:text-gray-600 dark:text-white dark:hover:text-gray-400"
                        ...
                        <a href="mailto:elsonng.freelance@gmail.com" target="_blank">
                            <svg
                                viewBox="0 0 1024 1024"
                                fill="currentColor"
                                className="w-8 h-8 text-black  hover:text-gray-600 dark:text-white dark:hover:text-gray-400"
                ...
                <article className="prose max-w-none prose-lg pt-8 pb-7 dark:prose-invert xl:col-span-2">
                    {/* <h3 className="pt-4 pb-2 text-2xl font-bold leading-6 tracking-normal">
                        Background
                    </h3> */}
                    <FadeInContent>
                    ...
                    {experience.map((data, index) => ExperienceListing(data, index))}
...
{/*                     {education.map((data) => EducationListing(data))} */}
                </article>
