...
export default function ScrollToTopButton() {
    ...
    return (<motion.button type="button" className="group fixed bottom-0 right-0 p-10" variants={ScrollToTopContainerVariants} animate={controls} onClick={scrollToTop}
