...
//             }}
//             ref={formRef}
//             style={{opacity: pending ? 0.7 : 1.0}}
//             className="relative flex items-center text-sm mb-5"
//         >
//             <input type="text" placeholder="Your message..." name="entry" required 
//             disabled = {pending}
//             className="pl-4 pr-32 py-2 mt-1 focus:ring-teal-500 focus:border-teal-500 block w-full border-neutral-300 rounded-md bg-gray-100 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100"></input>
